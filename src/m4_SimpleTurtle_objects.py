...
#
###############################################################################
deku = rg.SimpleTurtle()
deku.speed = 30
deku.pen = rg.Pen('green', 10)
deku.backward(150)
baku = rg.SimpleTurtle()
baku.pen = rg.Pen('orange', 15)
baku.speed = 50
baku.forward(50)
tsuyu = rg.SimpleTurtle()
tsuyu.pen = rg.Pen('blue', 20)
tsuyu.forward(100)
tsuyu.go_to(rg.Point(50, 300))
deku.right(180)
